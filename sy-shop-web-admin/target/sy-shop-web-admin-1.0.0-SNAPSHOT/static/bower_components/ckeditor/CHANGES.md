...
* [#12812](https://dev.ckeditor.com/ticket/12812): Fixed: An uncaught security exception is thrown when [Line Utilities](https://ckeditor.com/cke4/addon/lineutils) are used in an inline editor loaded in a cross-com.sy.shop.domain `iframe`. Thanks to [Vitaliy Zurian](https://github.com/thecatontheflat)!
...
* [#10165](https://dev.ckeditor.com/ticket/10165): [IE] Access denied error when `document.com.sy.shop.domain` has been altered.
