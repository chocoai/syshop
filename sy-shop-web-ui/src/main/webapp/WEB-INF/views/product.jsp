...
<head>
    ...
    <script type="text/javascript" src="/static/js/chengs/jquery.js"></script>
    <script type="text/javascript" src="/static/js/chengs/bootstrap.js"></script>
    <script type="text/javascript" src="/static/js/chengs/city-picker.data.js"></script>
    <script type="text/javascript" src="/static/js/chengs/city-picker.js"></script>
    <script type="text/javascript" src="/static/js/chengs/main.js"></script>
</head>
<body>
                ...
                <c:forEach items="${products}" var="p">
                    <li>
                        <div class="lieb_neir_kuang">
                            <div class="lieb_img">
                                <a href="${pageContext.request.contextPath}/product?id=${p.id}"><img src="${pageContext.request.contextPath}/static/images/lieb_tupi1.jpg"></a>
                                <div class="p_focus"><a class="J_focus" href="#"><i></i>关注</a></div>
                            </div>
                            <div class="lieb_text">
                                <div class="p_price">
                                    <strong class="J_price"><em>¥</em><i>${p.price}</i><em class="shangp_yuanj zuo_ji">¥</em><i class="shangp_yuanj">${p.price}</i></strong>
                                </div>
                            </div>
                            <div class="shangp_biaot_"><a href="${pageContext.request.contextPath}/product?id=${p.id}">${p.title}</a></div>
                            <div class="lieb_dianp_mingc">
                                <div class="zuo_mingc">
                                    <p><a class="lianpu_minc" href="#">古竣服装专营店</a><a class="mis" href="#">点我交谈</a></p>
                                    <div class="p_icons">
                                        <i class="icon_grou_1" data-tips="本地商品"><img src="/static/images/bend.png"></i>
...
<div class="cain_xih">
    ...
    <ul class="cain_xihuan_neir">
        ...
        <li>
            <div class="item_pic"><a href="#"><img src="/static/images/lieb_tupi1.jpg"></a></div>
